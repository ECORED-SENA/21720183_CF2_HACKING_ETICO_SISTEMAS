  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Levantamiento de huellas y herramientas de hacking ético.
        p.mb-4 Identificar los objetivos del footprinting y qué datos se pueden recoger las huellas según el tipo, para poder conocer vulnerabilidades de una organización.
